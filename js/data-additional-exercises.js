...
const DianaAdditionalExercises = (function () {
    ...
    const missingPlan1Exercises = {
        'Dead Bug': {
            ...
            sets: 3,
            reps: '15-18',
            image: 'IMG/dead_bug.png',  // Uses gradient placeholder
            needsImage: true,
        ...
        'gummiband-full': {
            ...
            sessions: [
                    ...
                    exercises: [
                        {
                            ...
                            exercises: [
                                ...
                                { name: 'Diagonal Band Walk', reps: '10-12', image: 'IMG/diagonal_band_walk.png', imagePrompt: 'Person doing diagonal band walk with resistance band around thighs, glute exercise' }
                            ]
                        },
                        { name: 'Standing Banded Row', sets: 3, reps: '10-12', image: 'IMG/standing_banded_row.png',
                                needsImage: false, imagePrompt: 'Person doing standing row with resistance band anchored in front, back exercise', tip: 'Stå framåtlutad och dra händerna med handtaget upp längs kroppen. Knip mellan skulderbladen.' },
                        {
                            name: 'Superset',
                            type: 'superset',
                            rounds: 3,
                            exercises: [
                                { name: 'Standing Banded Shoulder Press', reps: '10-12', image: null, imagePrompt: 'Person doing overhead press with resistance band under feet' },
                                { name: 'Banded Lateral Raise', reps: '10-12', image: 'IMG/banded_lateral_raise.png',
                                needsImage: false, imagePrompt: 'Person doing lateral raise with resistance band' }
                            ]
                        },
                        {
                            name: 'Superset',
                            ...
                            rounds: 3,
                            exercises: [
                                { name: 'Plank', reps: '30 sek', image: null, imagePrompt: 'Person holding plank position on forearms, core exercise' },
                                { name: 'Banded Alphabet', reps: '10-12', image: 'IMG/banded_alphabet.png',
                                needsImage: false, imagePrompt: 'Person doing band alphabet exercise with arms extended' }
                            ]
                        }
                    ]
                },
                {
                    ...
                    duration: 35,
                    exercises: [
                        { name: 'Bodyweight Sumo Squat', sets: 3, reps: '10-12', image: null, imagePrompt: 'Person doing wide stance sumo squat bodyweight exercise', tip: 'Lite bredare position, sätt dig ner och bibehåll en stolt hållning.' },
                        { name: 'Seated Banded Close Grip Row', sets: 3, reps: '10-12', image: 'IMG/seated_banded_close_grip_row.png',
                                needsImage: false, imagePrompt: 'Person seated doing close grip row with resistance band around feet', tip: 'Sitt med rak rygg och gummibandet runt fötterna. Dra armarna bakåt och ha armbågarna längs kroppens sida.' },
                        ...
                        { name: 'Half Kneeling Banded Face Pull', sets: 3, reps: '10-12', image: 'IMG/band_pull_apart.jpg',
                                needsImage: false, imagePrompt: 'Person in half kneeling position doing face pull with resistance band', tip: 'Stå på ett knä och dra bandet mot ansiktet med armbågarna högt.' },
                        {
                            name: 'Superset',
                            type: 'superset',
                            rounds: 3,
                        ...
                        { name: 'Burpee', sets: 3, reps: '10-12', image: 'IMG/burpee.png', imagePrompt: 'Person doing burpee exercise in motion, full body cardio', tip: 'Börja stående, sänk dig i knäböj, hoppa bakåt till plank, sänk kroppen, pressa upp och hoppa explosivt.' }
                    ]
                },
                {
                    ...
                    exercises: [
                        ...
                        { name: 'Banded Walking Lunge', sets: 3, reps: '10-12', image: 'IMG/banded_walking_lunge.png', imagePrompt: 'Person doing walking lunges with resistance band around thighs', tip: 'Höftbred position med fötterna, ta ett kliv fram med ena benet så att du hamnar i 90 graders vinkel i främre knäet.' },
                        {
                            name: 'Superset',
                            type: 'superset',
                            rounds: 3,
                            exercises: [
                                { name: 'Standing Banded Shoulder Press', reps: '10-12', image: null, imagePrompt: 'Person doing overhead press with resistance band' },
                                { name: 'Seated Banded Close Grip Row', reps: '10-12', image: 'IMG/seated_banded_close_grip_row.png',
                                needsImage: false, imagePrompt: 'Person seated doing row with resistance band' },
                                { name: 'Hyperextension', reps: '10-12', image: 'IMG/hyperextension.png',
                                needsImage: false, imagePrompt: 'Person doing back hyperextension on floor or bench' }
                            ]
                        },
                        { name: 'Banded Bent Over Rear Delt Fly', sets: 3, reps: '10-12', image: 'IMG/banded_bent_over_rear_delt_fly.png',
                                needsImage: false, imagePrompt: 'Person bent over doing rear delt fly with resistance band', tip: 'Stå framåtlutad med band under fötterna. Pressa armarna ut åt sidorna.' },
                        { name: 'Banded Upright Row', sets: 3, reps: '10-12', image: 'IMG/banded_upright_row.png',
                                needsImage: false, imagePrompt: 'Person doing upright row with resistance band under feet', tip: 'Stå på bandet och dra rakt uppåt med armbågarna utåt. Armbågarna går aldrig över axlarna.' },
                    ...
                    exercises: [
                        ...
                        { name: 'Wide Grip Pull Down', sets: 3, reps: '15-18', image: 'IMG/wide_grip_pull_down.jpg', tip: 'Brett grepp med handflatorna från dig. Dra ner stången till hakans höjd.' },
                        {
                            ...
                            exercises: [
                                ...
                                { name: 'Seated Bent Over Rear Delt Fly', reps: '15-18', image: 'IMG/floor_leg_raise.jpg',
                                needsImage: false, imagePrompt: 'Person seated bent over doing rear delt fly with dumbbells' }
                            ]
                        },
                    ...
                    exercises: [
                        { name: 'Leg Press', sets: 4, reps: '10-12', image: 'IMG/leg_press.jpg', tip: 'Placera fötterna höftbrett på plattan.' },
                        {
                            ...
                            exercises: [
                                ...
                                { name: 'Bodyweight Jump Squat', reps: '10-12', image: 'IMG/seated_dumbbell_press.jpg',
                                needsImage: false, imagePrompt: 'Person doing explosive jump squat, catching air, leg exercise' }
                            ]
                        },
                        {
                            name: 'Superset',
                            ...
                            rounds: 3,
                            exercises: [
                                { name: 'Machine Chest Press', reps: '8', image: null, imagePrompt: 'Person using chest press machine in gym, chest exercise' },
                                { name: 'Incline Push Up', reps: '8', image: 'IMG/incline_push_up.png',
                                needsImage: false, imagePrompt: 'Person doing incline push up with hands on bench, chest exercise' }
                            ]
                        },
                        ...
                        { name: 'Russian Twist', sets: 3, reps: '12', image: 'IMG/seated_cable_row.jpg',
                                needsImage: false, imagePrompt: 'Person doing Russian twist with weight, rotating torso side to side, ab exercise', tip: 'Stolt bröst, axlarna sänkta. Pendla med hela överkroppen från höger till vänster sida.' }
                    ]
                }
            ]
        }
